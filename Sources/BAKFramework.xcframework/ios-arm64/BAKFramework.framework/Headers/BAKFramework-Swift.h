...
#ifndef BAKFRAMEWORK_SWIFT_H
#define BAKFRAMEWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BAKFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12BAKFramework14BAKAppDelegate")
...
@interface BAKFramework : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) BAKFramework * _Nonnull shared;)
+ (BAKFramework * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
+ (void)setShared:(BAKFramework * _Nonnull)value;
...
@interface BAKFramework (SWIFT_EXTENSION(BAKFramework)) <AppsFlyerLibDelegate>
